                                    ...
                                    <div class="card-body">
                                        <form id="frmLogin">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="usuario" name="usuario" type="text" placeholder="Ingrese usuario" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="clave"><i class="fas fa-key"></i> Contraseña</label>
                                                <input class="form-control py-2" id="clave" type="password" name="clave" placeholder="Ingrese contraseña" />
                                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Centro Medico &copy; Estar Bien</div>
